    ...
    <article className="rounded-[1.5rem] border border-slate-200 bg-slate-950 p-6 text-white shadow-sm">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">{robot.description}</p>
        </div>
      ...
      <dl className="mt-5 grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
        ...
        <div>
          <dt className="text-slate-400">Navigation</dt>
          <dd className="mt-1 font-medium text-white">Autonomous mapping</dd>
        </div>
      </dl>
